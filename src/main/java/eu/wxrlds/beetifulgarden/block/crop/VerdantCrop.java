...
public class VerdantCrop extends BeetrootBlock implements IPlantable {
    Block plantableOn = ModBlocks.ParseConfigPlantableBlock(BeetifulGardenCommonConfigs.VERDANT_PLANTABLE_ON.get());

    public VerdantCrop(Properties properties) {
        super(properties);
    }
