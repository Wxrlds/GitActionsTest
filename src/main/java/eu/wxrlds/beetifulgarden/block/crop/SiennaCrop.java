...
public class SiennaCrop extends BeetrootBlock implements IPlantable {
    Block plantableOn = ModBlocks.ParseConfigPlantableBlock(BeetifulGardenCommonConfigs.SIENNA_PLANTABLE_ON.get());
