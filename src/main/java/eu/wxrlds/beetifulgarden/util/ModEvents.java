    ...
    public static void applyBeetifulEffectOnEaten(LivingEntityUseItemEvent.Finish event) {
        ...
        if (!event.getEntity().level.isClientSide()) {
            ...
            if (item == ModItems.CLOUDY_BEETIFUL.get()) {
                effects = Effects.ConfigEffectsToEffectInstanceList(BeetifulGardenCommonConfigs.CLOUDY_EFFECTS.get()).toArray(new EffectInstance[0]);
                ...
                effects = Effects.ConfigEffectsToEffectInstanceList(BeetifulGardenCommonConfigs.EMINENCE_EFFECTS.get()).toArray(new EffectInstance[0]);
                ...
                effects = Effects.ConfigEffectsToEffectInstanceList(BeetifulGardenCommonConfigs.MARINE_EFFECTS.get()).toArray(new EffectInstance[0]);
                ...
                effects = Effects.ConfigEffectsToEffectInstanceList(BeetifulGardenCommonConfigs.OLIVE_EFFECTS.get()).toArray(new EffectInstance[0]);
                ...
                effects = Effects.ConfigEffectsToEffectInstanceList(BeetifulGardenCommonConfigs.PISTACHIO_EFFECTS.get()).toArray(new EffectInstance[0]);
                ...
                effects = Effects.ConfigEffectsToEffectInstanceList(BeetifulGardenCommonConfigs.PIXIE_EFFECTS.get()).toArray(new EffectInstance[0]);
                ...
                effects = Effects.ConfigEffectsToEffectInstanceList(BeetifulGardenCommonConfigs.SIENNA_EFFECTS.get()).toArray(new EffectInstance[0]);
                ...
                effects = Effects.ConfigEffectsToEffectInstanceList(BeetifulGardenCommonConfigs.VELVET_EFFECTS.get()).toArray(new EffectInstance[0]);
                ...
                effects = Effects.ConfigEffectsToEffectInstanceList(BeetifulGardenCommonConfigs.VERDANT_EFFECTS.get()).toArray(new EffectInstance[0]);
                ...
                effects = Effects.ConfigEffectsToEffectInstanceList(BeetifulGardenCommonConfigs.VERDIGRIS_EFFECTS.get()).toArray(new EffectInstance[0]);
