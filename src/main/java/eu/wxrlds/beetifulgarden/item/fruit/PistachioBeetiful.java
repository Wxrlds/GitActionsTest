...
public class PistachioBeetiful extends Item {
    public PistachioBeetiful(Properties properties) {
        super(properties.food(new Food.Builder().alwaysEat().build()));
    }

    @Override
    public void appendHoverText(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        String effectString = BeetifulGardenCommonConfigs.PISTACHIO_EFFECTS.get();
